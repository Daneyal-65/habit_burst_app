...
function SupportPage() {
  return (
    <>
      <section
        className=" flex flex-col bgc
     bg-opacity-90 p-8 mx-12 rounded-lg"
      >
        <div
          className="flex flex-col lg:w-80 w-60 justify-center items-center
         bg-green-300 shadow-sm m-auto rounded-xl"
        >
          <h1 className=" text-blue-500 font-bold text-wrap shadow-3xl">
            How it Works?
          </h1>
        ...
        <main className="">
          <h1 className="regular-40 font-sans mx-12 my-4 bold-20 text-white">
            Key Features:
          </h1>
          <div className="textBold">Customizable Habit Creation:</div>
          <p className="bgcc">
            Easily create and customize your habits based on your goals. Define
            the habit name, set the frequency, and choose specific days and
            times for reminders.
          </p>
          ...
          <p className="bgcc">
            ...
            intuitive visualizations and streak tracking, allowing you to see
            how consistently you've been following your habits over time.
          </p>
          ...
          <p className="bgcc">
            ...
            daily reading. Unlock achievements and receive positive
            reinforcement as you make progress.
          </p>
          ...
          <p className="bgcc">
            ...
            interface, ensuring a seamless user experience. Navigate
            effortlessly, and enjoy a clean design that enhances your
